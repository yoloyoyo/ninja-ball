namespace SpriteKind {
    export const Red_Player = SpriteKind.create()
    export const Blue_Player = SpriteKind.create()
    export const Red_ninjaStar = SpriteKind.create()
